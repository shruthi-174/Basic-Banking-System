  ...
  <div id="logo">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#workSection">About Us</a>
        </li>
        <li class="nav-item">
...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #89CFF0">Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
         ...
         <footer class="text-center mt-5 py-2">
            <p style="color:white;">&copy 2021  <b> Shruthi Mohan</b> </br>For the project of The Sparks Foundation</p>
        </footer>
